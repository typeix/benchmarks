...
const packages = {
  ...
  'nestjs-fastify.js': { checked: false, hasRouter: true, package: '@nestjs/platform-fastify' },
  'nestjs-express.js': { checked: false, hasRouter: true, package: '@nestjs/platform-express' },
  'typeix-resty.js': { checked: false,  hasRouter: true, package: '@typeix/resty' },
